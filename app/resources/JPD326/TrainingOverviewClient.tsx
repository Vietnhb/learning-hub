...
export default function TrainingOverviewClient({
  vocabularyCount,
  kanjiCount,
  grammarCount,
  ...
  const categories = [
    {
      ...
      link: "/resources/JPD326/vocabulary",
    },
    {
      id: 2,
      title: "文法",
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-pink-50 via-white to-pink-100 px-3 py-6 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 sm:px-4 sm:py-12">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <div className="inline-block relative">
            ...
            {/* Main header card */}
            <div className="relative rounded-2xl border-2 border-pink-400 bg-white/95 px-4 py-6 shadow-xl backdrop-blur dark:border-pink-700 dark:bg-gray-800/95 sm:rounded-3xl sm:border-4 sm:px-12 sm:py-8 sm:shadow-2xl">
              ...
              <div className="absolute -top-5 right-2 flex h-16 w-16 rotate-12 items-center justify-center rounded-full border-4 border-white bg-gradient-to-br from-pink-400 to-rose-500 shadow-xl sm:-right-8 sm:-top-8 sm:h-24 sm:w-24">
                <span className="text-5xl">🌸</span>
              </div>
              ...
              <div className="mb-4">
                <div className="flex items-center justify-center gap-4 mb-3">
                  <span className="text-4xl">🌸</span>
                  <h1 className="bg-gradient-to-r from-pink-500 via-rose-500 to-red-500 bg-clip-text text-3xl font-black tracking-normal text-transparent sm:text-6xl sm:tracking-wider">
                    日本語 JPD326
                  </h1>
                  <span className="text-4xl">🌸</span>
                </div>
              ...
              <Link href={category.link}>
                ...
                >
                  ...
                  <CardHeader className="text-center pt-10 pb-3 px-6">
                    ...
                    {/* Japanese Title */}
                    <CardTitle
                      className={`mb-2 text-4xl font-black sm:text-5xl ${category.textColor} font-japanese-serif tracking-tight`}
                    >
                      {category.title}
                    </CardTitle>

...
const sections = [
  {
    ...
    detail: "357 questions",
    icon: BookOpenCheck,
    accent: "bg-blue-400",
  },
];

export default function ITE302cPage() {
  return (
    <main className="min-h-screen bg-[#f5f1e8] px-4 py-8 text-slate-950 dark:bg-slate-950 dark:text-white sm:px-6 lg:px-8">
      <div className="mx-auto w-full max-w-6xl">
        <Link
          href="/resources"
          className="inline-flex items-center gap-2 text-sm font-semibold text-slate-600 transition hover:text-blue-700 dark:text-slate-300 dark:hover:text-blue-300"
        >
        ...
        <header className="mt-8 max-w-3xl">
          ...
          <p className="mt-4 text-lg leading-relaxed text-slate-600 dark:text-slate-300">
            Explore ethical considerations in artificial intelligence development and deployment.
          </p>
        </header>

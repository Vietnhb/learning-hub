  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-100 px-3 py-6 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 sm:px-4 sm:py-12">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="relative rounded-2xl border-2 border-orange-400 bg-white/95 px-4 py-6 shadow-xl backdrop-blur dark:border-orange-700 dark:bg-gray-800/95 sm:rounded-3xl sm:border-4 sm:px-12 sm:py-8 sm:shadow-2xl">
            {/* FPT Logo Style Badge */}
            <div className="absolute -top-5 right-2 flex h-16 w-16 items-center justify-center rounded-full border-4 border-white bg-gradient-to-br from-orange-500 to-amber-600 shadow-xl sm:-right-8 sm:-top-8 sm:h-24 sm:w-24">
              <span className="text-2xl font-bold text-white sm:text-4xl">FPT</span>
            </div>

            {/* Title */}
            <div className="mb-4">
              <div className="mb-3 flex items-center justify-center gap-2 sm:gap-4">
                <span className="hidden text-4xl sm:inline">📚</span>
                <h1 className="bg-gradient-to-r from-orange-600 via-amber-500 to-yellow-600 bg-clip-text text-3xl font-black tracking-normal text-transparent sm:text-6xl sm:tracking-wider">
